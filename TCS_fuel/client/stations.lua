local blipNameFuel = replaceString(getText("fuel_station"), {getText("vehicle")})
local blipNameFuelBoat = replaceString(getText("fuel_station"), {getText("vehicle_boat")})
local blipNameFuelAvions = replaceString(getText("fuel_station"), {getText("vehicle_plane")})
local blipNameFuelHeli = replaceString(getText("fuel_station"), {getText("vehicle_heli")})
